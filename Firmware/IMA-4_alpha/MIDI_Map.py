...
#               2016
# Note and CC Mappings for the JAMP_alpha script (APC emulation) are defined in this file
...
ZOOMUP = 120 #Session Zoom up (Moves 4 tracks/scenes)
ZOOMDOWN = 121 #Session Zoom down
ZOOMLEFT = 122 #Session Zoom left
ZOOMRIGHT = 123 #Session Zoom right
SESSIONUP = 124 #Session up
SESSIONDOWN = 125 #Session down
SESSIONLEFT = 126 #Session left
SESSIONRIGHT = 127 #Session right
...
DRUM_PADS = (0, 1, 2, 3, # MIDI note numbers for 4 x 4 Drum Rack
             16, 17, 18, 19, # Mapping will be disabled if any notes are set to -1
             32, 33, 34, 35, # Notes will be "swallowed" if already mapped elsewhere
             48, 49, 50, 51,
             )
...
MASTERVOLUME = 7 #Master track volume
CUELEVEL = -1 #Cue level control
CROSSFADER = 10 #Crossfader control

TRACKVOL = (16, #Track 1 Volume
            17, #Track 2
            18, #Track 3
            19, #Track 4
            -1, #Track 5
